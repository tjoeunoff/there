                ...
                <div class="swiper magazine-slider"> <!-- 관리자에서 매거진 게시판에 등록한 게시글의 썸네일, 제목, #태그가 슬라이드로 노출 (최근게시글 10개) -->
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"> 
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/magazine/wm_img01.jpg);"></div> <!-- 썸네일의 경우 img태그가 아닌 background-image로 -->
                        ...
                        <div class="swiper-slide">
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/magazine/wm_img02.jpg);"></div>
                                <div class="thumb-desc">
                        ...
                        <div class="swiper-slide">
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/magazine/wm_img03.jpg);"></div>
                                <div class="thumb-desc">
                        ...
                        <div class="swiper-slide">
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/magazine/wm_img04.jpg);"></div>
                                <div class="thumb-desc">
            ...
            <div class="top20-place-sect">
                ...
                <div class="swiper place-slider">   <!-- 관리자에서 등록한 장소 중 좋아요 눌린 수가 많은 상위 20개 장소를 썸네일, 장소명, #태그가 슬라이드로 노출 -->
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"> 
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/place/palce_thumb01.jpg);"></div> <!-- 썸네일의 경우 img태그가 아닌 background-image로 -->
                                <div class="thumb-desc">
                        ...
                        <div class="swiper-slide"> 
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/place/palce_thumb02.jpg);"></div> <!-- 썸네일의 경우 img태그가 아닌 background-image로 -->
                                <div class="thumb-desc">
                        ...
                        <div class="swiper-slide"> 
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/place/palce_thumb03.jpg);"></div> <!-- 썸네일의 경우 img태그가 아닌 background-image로 -->
                                <div class="thumb-desc">
                        ...
                        <div class="swiper-slide"> 
                            <a href="#">
                                <div class="thumb-img" style="background-image: url(img/place/palce_thumb04.jpg);"></div> <!-- 썸네일의 경우 img태그가 아닌 background-image로 -->
                                <div class="thumb-desc">
