...
<section class="admin_contents" id="form_link04" style="">
	<div class="container col-md-12">
		<div class="page-header">
        	<h2>플레이스 등록하기 <small>Place Add</small></h2>
        </div>
        ...
        <form action="${pageContext.request.contextPath}/admin/place" method="POST" class="form-horizontal" id="placeAdd">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="locationContent" class="col-sm-2 control-label">간략설명</label>
                  <div class="col-sm-10">
                      <textarea class="form-control" name="place_content" pattern=".{1,65535}" placeholder="이 플레이스에 대한 간단한 설명을 작성해주세요 (1000자 이내)" required></textarea>
                  </div>
              </div>
